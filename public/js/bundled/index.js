...
if (mapBox) {
    ...
    (0, _mapBox.displayLocations)(locations);
}
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    ...
    (0, _login.loginFn)(email, password);
});
if (userUpdateData) userUpdateData.addEventListener("submit", (e)=>{
    e.preventDefault();
...
if (userUpdatePass) userUpdatePass.addEventListener("submit", async (e)=>{
    e.preventDefault();
    ...
    document.querySelector(".save--new--password").textContent = "Save password";
    document.getElementById("password-current").value = "";
    document.getElementById("password").value = "";
    document.getElementById("password-confirm").value = "";
});

},{"./login":"7yHem","./mapBox":"k6XpQ","./updateSettings":"l3cGY"}],"7yHem":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loginFn", ()=>loginFn);
...
const loginFn = async (email, password)=>{
    try {
        ...
        const res = await (0, _axiosDefault.default)({
            ...
            headers: {
                "Content-Security-Policy": "connect-src 'self' https://cdnjs.cloudflare.com"
            }
        });
...
const logOut = async ()=>{
    try {
        ...
        (0, _alert.showAlert)("error", "Logging out faild, please try again!");
    }
};
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayLocations", ()=>displayLocations);
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === "data" ? "http://127.0.0.1:3000/api/v3/users/updateMe" : "http://127.0.0.1:3000/api/v3/users/updatemypassword";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
        });
        const msg = type === "data" ? "DATA updatd successfuly" : "PASSWORD updatd successfuly";
        if (res.data.status === "success") (0, _alert.showAlert)("success", msg);
    // if (res.data.status === 'success') {
